"""
Django settings for test_prd_approval__123845 project.
...
ROOT_URLCONF = 'test_prd_approval__123845.urls'
...
WSGI_APPLICATION = 'test_prd_approval__123845.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_prd_approval__123845 API",
    "DESCRIPTION": "API documentation for test_prd_approval__123845 App",
    "VERSION": "v1",
}
