...
## Project Structure
    ...
    ├── test_prd_approval__123845  # Django project configurations
...
1. Clone this repo and `cd test_prd_approval__123845`
...
2. Clone this repo and `cd test_prd_approval__123845`
